...
namespace PhysX
{
	...
	class InternalVehicleSceneQueryData
	{
		protected:
			InternalVehicleSceneQueryData();
			~InternalVehicleSceneQueryData();
		...
		public:
			...
			static InternalVehicleSceneQueryData* allocate
			...
			static PxBatchQuery* setUpBatchedSceneQuery(const PxU32 batchId, const InternalVehicleSceneQueryData& vehicleSceneQueryData, PxScene* scene);
